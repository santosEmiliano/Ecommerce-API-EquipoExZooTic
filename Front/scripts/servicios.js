...
const logout = async () => {
  try {
    const res = await fetch("/back/auth/logout", {
      method: "POST",
      headers: {
...
const enviarCorreoContacto = async (formData) => {
  try {
    const response = await fetch("/back/api/contacto", {
      method: "POST",
      headers: {
        Authorization: `Bearer ${localStorage.getItem("token")}`,
        "Content-Type": "application/json",
...
const pagar = async () => {
  ...
  try {
    const response = await fetch(`/back/api/compra/${id}`, {
      method: "POST",
      headers: {
        Authorization: `Bearer ${localStorage.getItem("token")}`,
        "Content-Type": "application/json",
...
const enviarCorreoSuscripcion = async (email) => {
  try {
    const response = await fetch("/back/api/suscripcion", {
      method: "POST",
      headers: {
        Authorization: `Bearer ${localStorage.getItem("token")}`,
        "Content-Type": "application/json",
...
const signIn = async (_nombre, _correo, _pais, _contrasena) => {
  try {
    const response = await fetch("/back/auth/usuario", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
const getProd = async (filtros = {}) => {
  ...
  try {
    const response = await fetch(
      `/back/api/crud/productos?${params}`
    );
...
const addProduct = async (formData) => {
  try {
    const response = await fetch("/back/api/crud/productos", {
      method: "POST",
      headers: {
        Authorization: `Bearer ${localStorage.getItem("token")}`,
      },
...
const obtenerVentasTotales = async () => {
  try {
    const response = await fetch(`/back/stats/ventas-total`, {
      method: "GET",
      headers: {
        Authorization: `Bearer ${localStorage.getItem("token")}`,
      },
...
const obtenerExistencias = async () => {
  try {
    const response = await fetch(`/back/stats/existencias`, {
      method: "GET",
      headers: {
        Authorization: `Bearer ${localStorage.getItem("token")}`,
      },
...
const obtenerCarrito = async () => {
  const id = localStorage.getItem("id");
  try {
    const response = await fetch(`/back/api/carrito/${id}`, {
      method: "GET",
      headers: {
        Authorization: `Bearer ${localStorage.getItem("token")}`,
      },
...
const modificarProductoCarrito = async (idProducto, cantidad) => {
  ...
  try {
    const response = await fetch(
      `/back/api/carrito/${idUsuario}/producto/${idProducto}`,
      {
        method: "PUT",
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
...
const verificarCupon = async (cupon) => {
  try {
    const id = localStorage.getItem("id");
    const response = await fetch(`/back/api/cupon/${cupon}`, {
      method: "GET",
      headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
    });
...
const solicitarRecuperacion = async (email) => {
  try {
    const response = await fetch("/back/auth/forgot-password", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
