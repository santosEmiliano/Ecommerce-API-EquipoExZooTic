...
const login = async (correo, contrasena, captcha) => {
  try {
    const respuesta = await fetch("https://72.60.228.244:3000/back/auth/login", {
      method: "POST",
      headers: {
...
const logout = async () => {
  try {
    const res = await fetch("https://72.60.228.244:3000/back/auth/logout", {
      method: "POST",
      headers: {
...
const enviarCorreoContacto = async (formData) => {
  try {
    const response = await fetch("https://72.60.228.244:3000/back/api/contacto", {
      method: "POST",
      headers: {
        Authorization: `Bearer ${localStorage.getItem("token")}`,
        "Content-Type": "application/json",
...
const pagar = async () => {
  ...
  try {
    const response = await fetch(`https://72.60.228.244:3000/back/api/compra/${id}`, {
      method: "POST",
      headers: {
        Authorization: `Bearer ${localStorage.getItem("token")}`,
        "Content-Type": "application/json",
...
const enviarCorreoSuscripcion = async (email) => {
  try {
    const response = await fetch("https://72.60.228.244:3000/back/api/suscripcion", {
      method: "POST",
      headers: {
        Authorization: `Bearer ${localStorage.getItem("token")}`,
        "Content-Type": "application/json",
...
const signIn = async (_nombre, _correo, _pais, _contrasena) => {
  try {
    const response = await fetch("https://72.60.228.244:3000/back/auth/usuario", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
const getProd = async (filtros = {}) => {
  ...
  try {
    const response = await fetch(
      `https://72.60.228.244:3000/back/api/crud/productos?${params}`
    );
...
const getProdById = async (id) => {
  try {
    const response = await fetch(
      `https://72.60.228.244:3000/back/api/crud/productos/${id}`
    );
...
const addProduct = async (formData) => {
  try {
    const response = await fetch("https://72.60.228.244:3000/back/api/crud/productos", {
      method: "POST",
      headers: {
        Authorization: `Bearer ${localStorage.getItem("token")}`,
      },
...
const obtenerVentasCategoria = async () => {
  try {
    const response = await fetch(
      `https://72.60.228.244:3000/back/stats/ventas-categoria`,
      {
        method: "GET",
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
...
const obtenerVentasTotales = async () => {
  try {
    const response = await fetch(`https://72.60.228.244:3000/back/stats/ventas-total`, {
      method: "GET",
      headers: {
        Authorization: `Bearer ${localStorage.getItem("token")}`,
      },
...
const obtenerExistencias = async () => {
  try {
    const response = await fetch(`https://72.60.228.244:3000/back/stats/existencias`, {
      method: "GET",
      headers: {
        Authorization: `Bearer ${localStorage.getItem("token")}`,
      },
...
const cargarCaptcha = async () => {
  try {
    const res = await fetch("https://72.60.228.244:3000/back/captcha");
...
const obtenerCarrito = async () => {
  const id = localStorage.getItem("id");
  try {
    const response = await fetch(`https://72.60.228.244:3000/back/api/carrito/${id}`, {
      method: "GET",
      headers: {
        Authorization: `Bearer ${localStorage.getItem("token")}`,
      },
...
const modificarProductoCarrito = async (idProducto, cantidad) => {
  ...
  try {
    const response = await fetch(
      `https://72.60.228.244:3000/back/api/carrito/${idUsuario}/producto/${idProducto}`,
      {
        method: "PUT",
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
...
const verificarCupon = async (cupon) => {
  try {
    const id = localStorage.getItem("id");
    const response = await fetch(`https://72.60.228.244:3000/back/api/cupon/${cupon}`, {
      method: "GET",
      headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
    });
...
const solicitarRecuperacion = async (email) => {
  try {
    const response = await fetch("https://72.60.228.244:3000/back/auth/forgot-password", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
const restablecerContrasena = async (token, nuevaContrasena) => {
  try {
    const response = await fetch("https://72.60.228.244:3000/back/auth/reset-password", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
